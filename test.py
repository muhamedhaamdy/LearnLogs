...
with app.app_context():
    ...
    saad = Student(student_name='saad', email='saad@gmail.com', password='$2b$12$4HKAnkwr1uqmtbLsZsNHleYLAspcYhmx3ZEAr8AequRzFnY21MUBO', student_phone='12345678901', parent_name='saad parent', parent_phone='12345678901', address='saad address', grade='first')
    umar = Student(student_name='umar', email='umar@gmail.com', password='$2b$12$4HKAnkwr1uqmtbLsZsNHleYLAspcYhmx3ZEAr8AequRzFnY21MUBO', student_phone='12345678901', parent_name='umar parent', parent_phone='12345678901', address='umar address', grade='second')
    bor3y = Student(student_name='bor3y', email='bor3y@gmail.com', password='$2b$12$4HKAnkwr1uqmtbLsZsNHleYLAspcYhmx3ZEAr8AequRzFnY21MUBO', student_phone='12345678901', parent_name='bor3y parent', parent_phone='12345678901', address='bor3y address', grade='first')
    hazems = Student(student_name='hazems', email='hazme@gmail.com', password='$2b$12$4HKAnkwr1uqmtbLsZsNHleYLAspcYhmx3ZEAr8AequRzFnY21MUBO', student_phone='12345678901', parent_name='hazems parent', parent_phone='12345678901', address='hazems address', grade='third')
    khalil = Student(student_name='khalil', email='khalil@gmail.com', password='$2b$12$4HKAnkwr1uqmtbLsZsNHleYLAspcYhmx3ZEAr8AequRzFnY21MUBO', student_phone='12345678901', parent_name='khalil parent', parent_phone='12345678901', address='khalil address', grade='first')
    abdo = Student(student_name='abdo', email='abdo@gmail.com', password='$2b$12$4HKAnkwr1uqmtbLsZsNHleYLAspcYhmx3ZEAr8AequRzFnY21MUBO', student_phone='12345678901', parent_name='abdo parent', parent_phone='12345678901', address='abdo address', grade='second')
    ...
    hoda = Student(student_name='hoda', email='hoda@gmail.com', password='pas$2b$12$4HKAnkwr1uqmtbLsZsNHleYLAspcYhmx3ZEAr8AequRzFnY21MUBOsword', student_phone='12345678901', parent_name='swefy parent', parent_phone='12345678901', address='hoda address', grade='third')
    ...
    teacher = Student(student_name='teacher', email='teacher@gmail.com', password='$2b$12$4HKAnkwr1uqmtbLsZsNHleYLAspcYhmx3ZEAr8AequRzFnY21MUBO', student_phone='12345678901', parent_name='teacher parent', parent_phone='12345678901', address='teacher address', grade='teacher')
    ...
    db.session.add_all([session_first1, session_first2, session_first3])
    db.session.commit()
    ...
    student_session_entry10 = Student_Session.insert().values(student_id=bor3y.id, session_id=session_first2.id, mark=6)
    student_session_entry11 = Student_Session.insert().values(student_id=bor3y.id, session_id=session_first3.id, mark=7)
    student_session_entry12 = Student_Session.insert().values(student_id=khalil.id, session_id=session_first1.id, mark=10)
    student_session_entry13 = Student_Session.insert().values(student_id=khalil.id, session_id=session_first2.id, mark=10)
    student_session_entry14 = Student_Session.insert().values(student_id=khalil.id, session_id=session_first3.id, mark=10)
    ...
    db.session.execute(student_session_entry11)
    db.session.execute(student_session_entry12)
    db.session.execute(student_session_entry13)
    db.session.execute(student_session_entry14)
    ...
    firts_grade_rating = get_top('first')
    print(firts_grade_rating)
    rating = 0

    target_key = saad.id
    for index, (key, value) in enumerate(firts_grade_rating.items()):
        if key == target_key:
            rating = index + 1
            break
    print(rating)
